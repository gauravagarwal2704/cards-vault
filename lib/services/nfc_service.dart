...
class NfcService {
  ...
  Future<String> _transceiveWithRetry(
    String command, {
    int maxRetries = 3,
  }) async {
    int attempts = 0;
    ...
    while (attempts < maxRetries) {
      try {
        ...
        // #region agent log
        DebugLogger.log(
          'nfc_service.dart:transceive_retry',
          'Transceive attempt failed',
          {
            'attempt': attempts,
    ...
    throw lastException ??
        Exception('Transceive failed after $maxRetries attempts');
  }
  ...
  Future<NFCAvailability> getNfcAvailability() async {
    try {
      ...
      // #region agent log
      DebugLogger.log('nfc_service.dart:16', 'NFC availability response', {
      ...
      DebugLogger.log(
        'nfc_service.dart:18',
        'NFC availability check exception',
        {'error': e.toString()},
        'H1',
      );
      // #endregion
  ...
  Future<CardData?> readCard() async {
    ...
    try {
      ...
      // #region agent log
      DebugLogger.log('nfc_service.dart:36', 'NFC tag detected', {
      ...
      if (tag.type == NFCTagType.mifare_classic ||
        ...
        DebugLogger.log(
          'nfc_service.dart:39',
          'MIFARE card detected, not a payment card',
          {'tagType': tag.type.toString()},
          'H2',
        );
        // #endregion
        ...
        throw Exception(
          'This appears to be a MIFARE access card, not a payment card.',
        );
      }
      ...
      try {
        ...
        // #region agent log
        DebugLogger.log('nfc_service.dart:42', 'PPSE selected successfully', {
        ...
        // #region agent log
        DebugLogger.log('nfc_service.dart:44', 'AIDs extracted', {
          'count': aids.length,
          'aids': aids,
        }, 'H4');
        // #endregion
        ...
        DebugLogger.log(
          'nfc_service.dart:43',
          'PPSE failed, will try known AIDs directly',
          {'error': e.toString()},
          'H3',
        );
        // #endregion
      ...
      if (aids.isNotEmpty) {
        for (String aid in aids) {
          try {
            // #region agent log
            DebugLogger.log('nfc_service.dart:45', 'Trying AID from PPSE', {
              'aid': aid,
            }, 'H4');
            // #endregion
            ...
            DebugLogger.log(
              'nfc_service.dart:47',
              'AID selection failed, trying next',
              {'aid': aid, 'error': e.toString()},
              'H4',
            );
            // #endregion
            continue;
      ...
      if (selectResponse == null) {
        ...
        DebugLogger.log(
          'nfc_service.dart:48',
          'No AID from PPSE worked, trying known AIDs',
      ...
      // #region agent log
      DebugLogger.log('nfc_service.dart:48', 'GPO completed', {
      ...
      // #region agent log
      DebugLogger.log('nfc_service.dart:50', 'Card data read successfully', {
      ...
      // #region agent log
      DebugLogger.log('nfc_service.dart:55', 'readCard exception', {
        'error': e.toString(),
        'stackTrace': e is Error ? e.stackTrace.toString() : 'N/A',
      }, 'H2');
      // #endregion
      ...
      if (e.toString().contains('All known AIDs failed')) {
      ...
      } else if (e.toString().contains('PPSE') ||
          e.toString().contains('AID')) {
        ...
        errorMessage =
            "Card found but couldn't read data. Try camera or manual entry.";
      }
  ...
  Future<String> _selectPPSE() async {
    try {
      // #region agent log
      DebugLogger.log('nfc_service.dart:63', 'Sending PPSE select command', {
        'command': ApduCommands.selectPpse,
      }, 'H3');
      // #endregion
      String response = await _transceiveWithRetry(ApduCommands.selectPpse);
      // #region agent log
      DebugLogger.log('nfc_service.dart:65', 'PPSE response received', {
        'response': response,
      ...
      // #region agent log
      DebugLogger.log('nfc_service.dart:71', 'PPSE status word', {
        'sw1sw2': sw1sw2,
      }, 'H3');
      // #endregion
      if (sw1sw2 != '9000') {
      ...
      // #region agent log
      DebugLogger.log('nfc_service.dart:77', 'PPSE selection exception', {
        'error': e.toString(),
      }, 'H3');
      // #endregion
      rethrow;
  ...
  Future<List<String>> _extractAIDs(String ppseResponse) async {
    ...
    try {
      ...
      DebugLogger.log(
        'nfc_service.dart:82',
        'Extracting AIDs from PPSE',
        {},
        'H4',
      );
      // #endregion
      List<int> responseBytes = HexUtils.hexToBytes(
        ppseResponse.substring(0, ppseResponse.length - 4),
      );

      Map<String, dynamic> tlvData = TLVParser.parse(responseBytes);
      // #region agent log
      DebugLogger.log('nfc_service.dart:86', 'TLV parsed', {
        'tags': tlvData.keys.toList(),
      }, 'H4');
      // #endregion
      ...
      Map<String, dynamic> proprietaryData = TLVParser.parse(
        fciProprietaryTemplate,
      );

      List<int>? fciIssuerDiscretionaryData = TLVParser.findTagBytes(
        proprietaryData,
        'BF0C',
      );
      ...
      while (index < discretionaryBytes.length) {
        ...
        if (discretionaryBytes[index] == 0x61) {
          ...
          List<int> applicationTemplate = discretionaryBytes.sublist(
            index,
            index + length,
          );
          ...
          if (aid != null && aid.isNotEmpty) {
            aids.add(aid);
            // #region agent log
            DebugLogger.log('nfc_service.dart:116', 'AID found', {
              'aid': aid,
            }, 'H4');
            // #endregion
          }
      ...
      // #region agent log
      DebugLogger.log('nfc_service.dart:120', 'All AIDs extracted', {
        'count': aids.length,
        'aids': aids,
      }, 'H4');
      // #endregion
      ...
      // #region agent log
      DebugLogger.log('nfc_service.dart:122', 'AID extraction exception', {
        'error': e.toString(),
      }, 'H4');
      // #endregion
  ...
  Future<String> _selectApplication(String aid) async {
    try {
      ...
      // #region agent log
      DebugLogger.log('nfc_service.dart:127', 'Selecting application', {
        'aid': aid,
        'command': selectAidCommand,
      }, 'H4');
      // #endregion
      ...
      if (response.length < 4) {
        throw Exception(
          'Invalid AID selection response: too short (${response.length} chars)',
        );
      }

      String sw1sw2 = response.substring(response.length - 4);
      // #region agent log
      DebugLogger.log('nfc_service.dart:135', 'AID selection status', {
        'sw1sw2': sw1sw2,
        'aid': aid,
      }, 'H4');
      // #endregion
      ...
      if (sw1sw2 != '9000') {
        throw Exception(
          'AID selection failed with status: $sw1sw2 (aid: $aid)',
        );
      }
      ...
      // #region agent log
      DebugLogger.log(
        'nfc_service.dart:141',
        'Application selection exception',
        {'aid': aid, 'error': e.toString()},
        'H4',
      );
      // #endregion
  ...
  Future<String> _tryKnownAIDs() async {
    ...
    // #region agent log
    DebugLogger.log(
      'nfc_service.dart:tryKnownAIDs',
      'Trying known payment AIDs',
      {'count': knownAIDs.length},
      'H4',
    );
    // #endregion
    ...
    for (var aidInfo in knownAIDs) {
      try {
        // #region agent log
        DebugLogger.log('nfc_service.dart:tryKnownAIDs', 'Trying known AID', {
          'name': aidInfo['name'],
          'aid': aidInfo['aid'],
        }, 'H4');
        // #endregion
        ...
        DebugLogger.log(
          'nfc_service.dart:tryKnownAIDs',
          'Known AID succeeded',
          {'name': aidInfo['name'], 'aid': aidInfo['aid']},
          'H4',
        );
        // #endregion
        ...
        // #region agent log
        DebugLogger.log('nfc_service.dart:tryKnownAIDs', 'Known AID failed', {
          'name': aidInfo['name'],
          'error': e.toString(),
        }, 'H4');
        // #endregion
  ...
  String _buildGPOCommand(String selectResponse) {
    try {
      List<int> responseBytes = HexUtils.hexToBytes(
        selectResponse.substring(0, selectResponse.length - 4),
      );
      ...
      if (fciTemplate != null) {
        ...
        if (a5Template != null) {
          ...
          if (pdol != null && pdol.isNotEmpty) {
            // #region agent log
            DebugLogger.log('nfc_service.dart:_buildGPOCommand', 'PDOL found', {
              'pdolHex': HexUtils.bytesToHex(pdol),
              'length': pdol.length,
            }, 'H5');
            // #endregion
            ...
            String pdolLengthHex = pdolDataLength
                .toRadixString(16)
                .padLeft(2, '0');
            int totalLength = pdolDataLength + 2;
            String totalLengthHex = totalLength
                .toRadixString(16)
                .padLeft(2, '0');

            String gpoCmd =
                "80A80000${totalLengthHex}83$pdolLengthHex${pdolDataHex}00";
            // #region agent log
            DebugLogger.log(
              'nfc_service.dart:_buildGPOCommand',
              'Built GPO with PDOL',
              {
                'command': gpoCmd,
                'pdolDataLength': pdolDataLength,
      ...
      DebugLogger.log(
        'nfc_service.dart:_buildGPOCommand',
        'No PDOL found, using default GPO',
        {},
        'H5',
      );
      // #endregion
      ...
      DebugLogger.log(
        'nfc_service.dart:_buildGPOCommand',
        'Error building GPO, using default',
        {'error': e.toString()},
        'H5',
      );
      // #endregion
  ...
  List<int> _getDefaultPDOLValue(String tag, int length) {
    switch (tag) {
      ...
      case '9F1C':
        if (length == 8) {
          return [0x38, 0x32, 0x33, 0x30, 0x30, 0x30, 0x30, 0x30];
        }
        return List.filled(length, 0x00);
      case '9F35':
  ...
  Future<String> _getProcessingOptions(String selectResponse) async {
    try {
      ...
      // #region agent log
      DebugLogger.log('nfc_service.dart:146', 'Sending GPO command', {
        'command': gpoCommand,
      }, 'H5');
      // #endregion
      String response = await _transceiveWithRetry(gpoCommand);
      // #region agent log
      DebugLogger.log('nfc_service.dart:148', 'GPO response received', {
        'response': response,
        'length': response.length,
      }, 'H5');
      // #endregion
      ...
      if (sw1sw2 == '6985') {
        // #region agent log
        DebugLogger.log(
          'nfc_service.dart:149',
          'GPO rejected (6985), trying simple GPO',
          {},
          'H5',
        );
        // #endregion
        ...
        // #region agent log
        DebugLogger.log('nfc_service.dart:150', 'Simple GPO response', {
          'response': response,
          'sw1sw2': sw1sw2,
        }, 'H5');
        // #endregion
      ...
      Map<String, dynamic> tlvData = TLVParser.parse(responseBytes);
      // #region agent log
      DebugLogger.log('nfc_service.dart:161', 'GPO TLV parsed', {
        'tags': tlvData.keys.toList(),
      }, 'H5');
      // #endregion
      ...
      if (aflData == null || aflData.isEmpty) {
        // #region agent log
        DebugLogger.log(
          'nfc_service.dart:173',
          'AFL not found in GPO',
          {},
          'H5',
        );
        // #endregion
        throw Exception(
          'AFL (Application File Locator) not found in GPO response',
        );
      }

      final List<int> aflDataFinal = aflData;
      // #region agent log
      DebugLogger.log('nfc_service.dart:176', 'AFL found', {
        'aflLength': aflDataFinal.length,
        'aflHex': HexUtils.bytesToHex(aflDataFinal),
      }, 'H5');
      // #endregion
      ...
      // #region agent log
      DebugLogger.log('nfc_service.dart:179', 'GPO exception', {
        'error': e.toString(),
      }, 'H5');
      // #endregion
  ...
  Future<CardData> _readRecords(String gpoResponse) async {
    ...
    try {
      ...
      List<int> gpoBytes = HexUtils.hexToBytes(
        gpoResponse.substring(0, gpoResponse.length - 4),
      );
      Map<String, dynamic> gpoTlv = TLVParser.parse(gpoBytes);

      // #region agent log
      DebugLogger.log(
        'nfc_service.dart:183',
        'Parsing GPO response for card data',
        {'tags': gpoTlv.keys.toList()},
        'H6',
      );
      // #endregion
      ...
      if (responseTemplate != null) {
        ...
        // #region agent log
        DebugLogger.log('nfc_service.dart:195', 'Extracted from GPO response', {
          'hasPAN': pan != null,
          'hasExpiry': expiryDate != null,
          'hasName': cardholderName != null,
        }, 'H6');
        // #endregion
      }
      ...
      if (pan != null && expiryDate != null) {
        // #region agent log
        DebugLogger.log(
          'nfc_service.dart:200',
          'Card data found in GPO response, skipping record reading',
          {},
          'H6',
        );
        // #endregion
      ...
      if (aflData == null || aflData.isEmpty) {
        // #region agent log
        DebugLogger.log(
          'nfc_service.dart:220',
          'No AFL found and no data in GPO',
          {},
          'H6',
        );
        // #endregion
        throw Exception(
          'No card data found in GPO response and no AFL to read records',
        );
      }

      // #region agent log
      DebugLogger.log(
        'nfc_service.dart:225',
        'Starting to read records from AFL',
        {'aflLength': aflData.length},
        'H6',
      );
      // #endregion
      ...
      for (int i = 0; i < aflData.length; i += 4) {
        ...
        // #region agent log
        DebugLogger.log('nfc_service.dart:192', 'Processing AFL entry', {
          'sfi': sfi,
        ...
        for (
          ...
          try {
            ...
            // #region agent log
            DebugLogger.log('nfc_service.dart:197', 'Reading record', {
              'recordNum': recordNum,
              'sfi': sfi,
              'command': readRecordCommand,
            }, 'H6');
            // #endregion
            String response = await _transceiveWithRetry(
              readRecordCommand,
              maxRetries: 2,
            );
            ...
            List<int> recordData = HexUtils.hexToBytes(
              response.substring(0, response.length - 4),
            );

            Map<String, dynamic> recordTlv = TLVParser.parse(recordData);
            // #region agent log
            DebugLogger.log('nfc_service.dart:208', 'Record parsed', {
              'tags': recordTlv.keys.toList(),
            }, 'H6');
            // #endregion
            ...
            if (pan != null) {
              DebugLogger.log(
                'nfc_service.dart:210',
                'PAN extracted from record',
                {'sfi': sfi, 'recordNum': recordNum},
                'H6',
              );
            }
            // #endregion
            ...
            if (expiryDate != null) {
              DebugLogger.log(
                'nfc_service.dart:212',
                'Expiry extracted from record',
                {'sfi': sfi, 'recordNum': recordNum},
                'H6',
              );
            }
            ...
            if (pan != null && expiryDate != null) {
              // #region agent log
              DebugLogger.log(
                'nfc_service.dart:215',
                'Found all required data, stopping record read',
                {'sfi': sfi, 'recordNum': recordNum},
                'H6',
              );
              // #endregion
            ...
            // #region agent log
            DebugLogger.log(
              'nfc_service.dart:218',
              'Record read failed, continuing',
              {'sfi': sfi, 'recordNum': recordNum, 'error': e.toString()},
              'H6',
            );
            // #endregion
            ...
            if (e.toString().contains('Tag was lost') ||
              ...
              DebugLogger.log(
                'nfc_service.dart:220',
                'Tag lost, checking if we have enough data',
                {'hasPAN': pan != null, 'hasExpiry': expiryDate != null},
                'H6',
              );
              // #endregion
              if (pan != null && expiryDate != null) {
        ...
        if (pan != null && expiryDate != null) {
          // #region agent log
          DebugLogger.log(
            'nfc_service.dart:223',
            'Breaking AFL loop, all data found',
            {},
            'H6',
          );
          // #endregion
      ...
      if (pan == null) {
        // #region agent log
        DebugLogger.log(
          'nfc_service.dart:229',
          'PAN not found after reading all available records',
          {'recordsAttempted': 'multiple'},
          'H6',
        );
        // #endregion
        throw Exception(
          'Card number (PAN) not found on card. Card may have been removed too early or data may be encrypted.',
        );
      }
      ...
      // #region agent log
      DebugLogger.log('nfc_service.dart:252', 'Read records exception', {
        'error': e.toString(),
      }, 'H6');
      // #endregion
        ...
        try {
          ...
          if (expiryBytes == null) {
            ...
            if (track2Bytes != null) {
              ...
              if (separatorIndex == -1) separatorIndex = track2Hex.indexOf('=');
              if (separatorIndex != -1 &&
                  separatorIndex + 4 < track2Hex.length) {
                String expiryYYMM = track2Hex.substring(
                  separatorIndex + 1,
                  separatorIndex + 5,
                );
